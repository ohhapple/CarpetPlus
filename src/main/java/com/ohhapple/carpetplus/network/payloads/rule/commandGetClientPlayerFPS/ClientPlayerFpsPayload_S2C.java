...
public class ClientPlayerFpsPayload_S2C extends PLUS_CustomPayload {
    private static final String ID = PLUS_PayloadManager.PacketId.CLIENT_PLAYER_FPS_S2C.getId();
